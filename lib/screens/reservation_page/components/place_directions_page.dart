...
class PlaceDirectionsPage extends StatelessWidget {
  const PlaceDirectionsPage({ Key? key }) : super(key: key);
    ...
    return Scaffold(
              ...
              Container(
               padding: EdgeInsets.symmetric(horizontal: 15, vertical: 15),
                ...
                child: Column(
                  ...
                  children: [
                    Text(provider.reservation.placeName, style: Theme.of(context).textTheme.labelMedium,),
                    // Container(
                    //   height: 100,
                    //   width: 220,
                    //   child: Text.rich(
      ...
      : Stack(
        children: [
          GoogleMap(
            initialCameraPosition: CameraPosition(
              target: LatLng(wrapperHomePageProvider.mainCity!['location'].latitude, wrapperHomePageProvider.mainCity!['location'].longitude),
              zoom: 14
            ),
          ),
          provider.isLoading
